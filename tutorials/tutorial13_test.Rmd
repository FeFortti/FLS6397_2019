...
url <- "https://github.com/JonnyPhillips/FLS6397_2019/raw/master/data/discursos.rds"
download.file(url, destfile="discursos.rds")

discursos <- readRDS("discursos.rds")
```
...
- [Capitulo 2 - Análise de Sentimento com textos](http://tidytextmining.com/sentiment.html)
