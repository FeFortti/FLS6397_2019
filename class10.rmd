...
## Aula 10 -  RMarkdown, e Integração R e Databases
...
1- Comece o [Tutorial 19](https://jonnyphillips.github.io/FLS6397_2019/tutorials/tutorial19.html) assim que chegar em sala de aula, sobre a integração entre R e SQL.
...
4- Se tiver terminado o Tutorial 8, vá para o [Tutorial 20](https://jonnyphillips.github.io/FLS6397_2019/tutorials/tutorial20.html), sobre RMarkdown.
...
Finalizar a leitura dos capítulos 1 (_Introduction_) a 18 (_Pipes_, no início da parte III) e 26 a 30 (parte V) do livro do livro _R for Data Science_, [aqui](http://r4ds.had.co.nz/).